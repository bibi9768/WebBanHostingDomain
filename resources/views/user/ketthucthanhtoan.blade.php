                                        ...
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 text-align-center">
                                                    <form>
                                                        @csrf
                                                        <h2><h1 class="cl-purple">Đặt hàng thành công</h1></h2>
                                                        <p class="intro no-margin">Hệ thống đã nhận được đơn hàng của
                                                            bạn.</p>
                                                        <p>Họ tên:</p>
                                                        <p></p>
                                                        <p>Địa chỉ:</p>
                                                        ...
                                                        <a href="{{route('getHomePage')}}/thanh-toan/"
                                                           class="button button-special button-orange v-ripple">Thanh
                                                            toán qua MoMo</a>
                                                        <a href="{{route('getHomePage')}}/thanh-toan/"
                                                           class="button button-special button-orange v-ripple">Thanh
                                                            toán qua VNPay</a>
