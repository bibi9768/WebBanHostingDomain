...
@section('title','Kiểm tra tên miền')
@section('content')
                                        ...
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-12 text-align-center">
                                                    <h2><h1>ĐĂNG KÝ <span class="cl-blue">TÊN MIỀN</span></h1></h2>
                                                    <p class="intro no-margin">Hãy đăng ký tên miền giá rẻ tại HTVIETNAM
                                                        ngay hôm nay để bảo vệ thương hiệu của bạn.</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12" style="text-align: center">
                                                    ...
                                                    @if($domaininfo['status']==1)
                                                        <br>
                                                        <b>Dưới đây là thông tin đăng ký:</b>
                                                        <br>
                                                        {!!   $domaininfo['info']!!}
                                                    @endif
